...
namespace ZMD
{
    public class ItemListController : MonoBehaviour 
    {
        ...
        void Start() => itemTemplate.SetActive(false);
        ...
        public void Remove(GameObject item) => Remove(GetItemIndex(item));
        ...
        public void RemoveLast() => Remove(items.Count - 1);
        ...
        public int GetItemIndex(GameObject item) => items.IndexOf(item);
    }
}
